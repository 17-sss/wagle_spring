	...
	<div id="p" style="width:1200px;">
		...
		<div id="table" style="height:100%; padding-bottom:50px;">
			...
			<div class="w3-center w3-margin-top">
				<br/><br/>
				<div class="w3-button" onclick="button_click('b',3, 1)" id="b1">전체</div>&nbsp;&nbsp;&nbsp;
				<div class="w3-button" onclick="button_click('b',3, 2)" id="b2">신청/환불</div>&nbsp;&nbsp;&nbsp;
				<div class="w3-button" onclick="button_click('b',3, 3)" id="b3">와글그룹</div>
			</div>
